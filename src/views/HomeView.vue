         ...
         <div class="cursor-pointer border-solid border-2 border-color-a-1 rounded-lg px-2 py-4 text-center" v-for="chapter in chapters" :key="chapter.id">
            <div>
               ...
               <dt class="flex smc:text-base lg:text-lg antialiased text-color-4 font-serif">
                <div id="shape" class="bg-color-a-2 smc:ml-3 ml-6 flex origin-center rotate-45 w-10 h-10 rounded-md items-center justify-items-center">
                  <span class="text-color-a-3 rotate-[320deg] ml-3">{{ chapter.number_latin }}</span>
                </div>
                <div class="flex-1 text-left smc:ml-4 ml-8">
